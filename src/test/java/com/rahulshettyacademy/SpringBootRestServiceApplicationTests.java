...
//	private MockMvc mockMvc;
	...
	//Mockito is used for creating mock data for the services
	// MockMVC is used for calling the mock service calls
	...
	public void addBookTest() {
		...
		ResponseEntity response = libCon.addBookImplementation(buildLibrary());
		...
		assertEquals("Book already exists", ad.getMsg());
	}
